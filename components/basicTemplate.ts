...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .instruction-tooltip.is-editing {
        ...
        const app = {
            ...
            init() {
                ...
                this.config.board.sounds.forEach(sound => {
                    const stored = localStorage.getItem('basic-sound-instructions-' + this.config.board.id + '-' + sound.id);
                    if (stored !== null) {
                        ...
                        if (editBtn && bodyText) {
                            editBtn.addEventListener('click', e => {
                                ...
                                saveBtn.addEventListener('click', ev => {
                                    ...
                                    localStorage.setItem('basic-sound-instructions-' + app.config.board.id + '-' + sound.id, val);
